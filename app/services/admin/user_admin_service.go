...
type UserService interface {
	...
	CreateUser(user models.UserAdmin) utils.Response
	UpdateUser(user models.UserAdmin) utils.Response
...
func (s *userService) CreateUser(user models.UserAdmin) utils.Response {
...
func (s *userService) UpdateUser(user models.UserAdmin) utils.Response {
